<template>
  <div class="news-wrapper">
    ...
    >
      ...
      <el-table-column label="Номер ПУ" sortable width="100">
        <template slot-scope="{ row }">
          <span>{{ row.numberDevice }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Тип ресурса" sortable width="120">
        <template slot-scope="{ row }">
      ...
      <el-table-column label="Квартира" sortable width="150">
        <template slot-scope="{ row }">
          <span>{{ row.nameFlat }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Прошлый период" sortable width="150">
        <template slot-scope="{ row }">
          <span>{{ row.lperiod_month }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Прошлый результат" sortable width="100">
        <template slot-scope="{ row }">
