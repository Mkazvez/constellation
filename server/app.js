...
const device = require('./routes/device.routes.js')
const deviceResult = require('./routes/deviceResult.routes.js')
...
const statusPortals = require('./routes/statusPortal.routes.js')
const app = express()
